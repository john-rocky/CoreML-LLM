...
GEMMA4_E2B_FILE_PATHS = [
    # Decode chunks (sdpa-8k/swa/)
    "sdpa-8k/swa/chunk1.mlmodelc/weights/weight.bin",
    "sdpa-8k/swa/chunk1.mlmodelc/coremldata.bin",
    "sdpa-8k/swa/chunk1.mlmodelc/model.mil",
    "sdpa-8k/swa/chunk1.mlmodelc/metadata.json",
    "sdpa-8k/swa/chunk1.mlmodelc/analytics/coremldata.bin",
    "sdpa-8k/swa/chunk2.mlmodelc/weights/weight.bin",
    "sdpa-8k/swa/chunk2.mlmodelc/coremldata.bin",
    "sdpa-8k/swa/chunk2.mlmodelc/model.mil",
    "sdpa-8k/swa/chunk2.mlmodelc/metadata.json",
    "sdpa-8k/swa/chunk2.mlmodelc/analytics/coremldata.bin",
    "sdpa-8k/swa/chunk3.mlmodelc/weights/weight.bin",
    "sdpa-8k/swa/chunk3.mlmodelc/coremldata.bin",
    "sdpa-8k/swa/chunk3.mlmodelc/model.mil",
    "sdpa-8k/swa/chunk3.mlmodelc/metadata.json",
    "sdpa-8k/swa/chunk3.mlmodelc/analytics/coremldata.bin",
    "sdpa-8k/swa/chunk4.mlmodelc/weights/weight.bin",
    "sdpa-8k/swa/chunk4.mlmodelc/coremldata.bin",
    "sdpa-8k/swa/chunk4.mlmodelc/model.mil",
    "sdpa-8k/swa/chunk4.mlmodelc/metadata.json",
    "sdpa-8k/swa/chunk4.mlmodelc/analytics/coremldata.bin",
    # Prefill chunks
    "sdpa-8k/prefill/prefill_chunk1.mlmodelc/coremldata.bin",
    "sdpa-8k/prefill/prefill_chunk1.mlmodelc/model.mil",
    "sdpa-8k/prefill/prefill_chunk1.mlmodelc/metadata.json",
    "sdpa-8k/prefill/prefill_chunk1.mlmodelc/analytics/coremldata.bin",
    "sdpa-8k/prefill/prefill_chunk2.mlmodelc/coremldata.bin",
    "sdpa-8k/prefill/prefill_chunk2.mlmodelc/model.mil",
    "sdpa-8k/prefill/prefill_chunk2.mlmodelc/metadata.json",
    "sdpa-8k/prefill/prefill_chunk2.mlmodelc/analytics/coremldata.bin",
    "sdpa-8k/prefill/prefill_chunk3.mlmodelc/coremldata.bin",
    "sdpa-8k/prefill/prefill_chunk3.mlmodelc/model.mil",
    "sdpa-8k/prefill/prefill_chunk3.mlmodelc/metadata.json",
    "sdpa-8k/prefill/prefill_chunk3.mlmodelc/analytics/coremldata.bin",
    "sdpa-8k/prefill/prefill_chunk4.mlmodelc/coremldata.bin",
    "sdpa-8k/prefill/prefill_chunk4.mlmodelc/model.mil",
    "sdpa-8k/prefill/prefill_chunk4.mlmodelc/metadata.json",
    "sdpa-8k/prefill/prefill_chunk4.mlmodelc/analytics/coremldata.bin",
    # Config + tokenizer
    "model_config.json",
...
def build_per_file_entries(model_repo: str, paths: list[str], api) -> list[dict]:
    ...
    for i, p in enumerate(paths):
        ...
        short_name = p.replace("sdpa-8k/swa/", "").replace("sdpa-8k/prefill/", "").replace("hf_model/", "hf_model/").replace("swa/", "")
        entries.append({
            "name":          short_name,
            "url":           f"{base}/{p}",
            "size_bytes":    int(size),
