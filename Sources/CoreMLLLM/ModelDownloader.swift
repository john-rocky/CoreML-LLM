    ...
    private func buildGemma4StatefulLinearFileList() {
        ...
        let extraFiles: [DownloadFile] = [
            ...
            .init(remotePath: "hf_model/config.json",
                  ...
                  estimatedSize: 5_000),
            // Stage 6 multimodal encoders + sidecars. The mlmodelc files
            // are the same ones legacy `gemma4e2b` ships under repo root,
            // re-uploaded under the stateful repo so a single picker
            // entry covers text+image+audio+video. Vision/audio are
            // optional at runtime (Gemma4StatefulEngine probes presence
            // at load() and lazy-loads the MLModel on first attachment).
            .init(remotePath: "vision.mlmodelc/weights/weight.bin",
                  localPath: "\(subdir)/vision.mlmodelc/weights/weight.bin",
                  estimatedSize: 320_000_000),
            .init(remotePath: "vision.mlmodelc/coremldata.bin",
                  localPath: "\(subdir)/vision.mlmodelc/coremldata.bin",
                  estimatedSize: 200_000),
            .init(remotePath: "vision.mlmodelc/model.mil",
                  localPath: "\(subdir)/vision.mlmodelc/model.mil",
                  estimatedSize: 50_000),
            .init(remotePath: "vision.mlmodelc/metadata.json",
                  localPath: "\(subdir)/vision.mlmodelc/metadata.json",
                  estimatedSize: 1_000),
            .init(remotePath: "vision.mlmodelc/analytics/coremldata.bin",
                  localPath: "\(subdir)/vision.mlmodelc/analytics/coremldata.bin",
                  estimatedSize: 1_000),
            .init(remotePath: "vision_video.mlmodelc/weights/weight.bin",
                  localPath: "\(subdir)/vision_video.mlmodelc/weights/weight.bin",
                  estimatedSize: 338_081_024),
            .init(remotePath: "vision_video.mlmodelc/coremldata.bin",
                  localPath: "\(subdir)/vision_video.mlmodelc/coremldata.bin",
                  estimatedSize: 418),
            .init(remotePath: "vision_video.mlmodelc/model.mil",
                  localPath: "\(subdir)/vision_video.mlmodelc/model.mil",
                  estimatedSize: 711_289),
            .init(remotePath: "vision_video.mlmodelc/metadata.json",
                  localPath: "\(subdir)/vision_video.mlmodelc/metadata.json",
                  estimatedSize: 2_721),
            .init(remotePath: "vision_video.mlmodelc/analytics/coremldata.bin",
                  localPath: "\(subdir)/vision_video.mlmodelc/analytics/coremldata.bin",
                  estimatedSize: 243),
            .init(remotePath: "audio.mlmodelc/weights/weight.bin",
                  localPath: "\(subdir)/audio.mlmodelc/weights/weight.bin",
                  estimatedSize: 295_373_248),
            .init(remotePath: "audio.mlmodelc/coremldata.bin",
                  localPath: "\(subdir)/audio.mlmodelc/coremldata.bin",
                  estimatedSize: 1_000),
            .init(remotePath: "audio.mlmodelc/model.mil",
                  localPath: "\(subdir)/audio.mlmodelc/model.mil",
                  estimatedSize: 759_000),
            .init(remotePath: "audio.mlmodelc/metadata.json",
                  localPath: "\(subdir)/audio.mlmodelc/metadata.json",
                  estimatedSize: 3_000),
            .init(remotePath: "audio.mlmodelc/analytics/coremldata.bin",
                  localPath: "\(subdir)/audio.mlmodelc/analytics/coremldata.bin",
                  estimatedSize: 250),
            .init(remotePath: "mel_filterbank.bin",
                  localPath: "\(subdir)/mel_filterbank.bin",
                  estimatedSize: 131_584),
            .init(remotePath: "audio_config.json",
                  localPath: "\(subdir)/audio_config.json",
                  estimatedSize: 500),
            .init(remotePath: "output_proj_weight.npy",
                  localPath: "\(subdir)/output_proj_weight.npy",
                  estimatedSize: 3_145_856),
            .init(remotePath: "output_proj_bias.npy",
                  localPath: "\(subdir)/output_proj_bias.npy",
                  estimatedSize: 3_200),
            .init(remotePath: "embed_proj_weight.npy",
                  localPath: "\(subdir)/embed_proj_weight.npy",
                  estimatedSize: 4_718_720),
        ]
